    ...
    <div className='recruitment' id={ENAV.RECRUITMENT}>
      <Section>
        <div className='recruitment__section'>
          ...
          <p className='section__subtitle'>Мы приглашаем студентов транспортных вузов и других технических университетов, которым интересно решать реальные задачи отрасли.</p>
