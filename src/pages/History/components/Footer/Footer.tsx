      ...
      <div className='h-footer__container'>
        ...
        <div className='h-footer__bottom'>
          ...
          <div className='h-footer__navigation'>
            ...
            <Link className='h-header__item' to='cases' smooth={true} offset={-40} duration={1250} spy={true}>Кейсы</Link>
            <Link className='h-header__item' to='final' smooth={true} offset={0} duration={1000} spy={true}>Финал</Link>
            <Link className='h-header__item' to='prize' smooth={true} offset={-40} duration={750} spy={true}>Призы</Link>
            <Link className='h-header__item' to='news' smooth={true} offset={-40} duration={500} spy={true}>СМИ</Link>
          </div>
        </div>
